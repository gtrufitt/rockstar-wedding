...
mr = (function(mr, $, window, document) {
    ...
    mr.forms.submit = function(e) {
        ...
        var body = $('body'),
            ...
            formAction = typeof thisForm.attr('action') !== typeof undefined
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (
                                ...
                                successRedirect = thisForm.attr(
                                    'data-success-redirect'
                                );
                                // For some browsers, if empty `successRedirect` is undefined; for others,
                                // `successRedirect` is false.  Check for both.
                                if (
                                    typeof successRedirect !==
                                        typeof undefined &&
    ...
    mr.maps.initAPI = function() {
        ...
        if (
            ...
            if ($('[data-maps-api-key]').length) {
                ...
                var apiKey = $('[data-maps-api-key]:first').attr(
                    'data-maps-api-key'
                );
        ...
        if (typeof window.google !== 'undefined') {
            if (typeof window.google.maps !== 'undefined') {
                $('.map-container[data-maps-api-key]').each(function() {
                    var mapElement = this,
                        mapInstance = $(this),
                        mapJSON = typeof mapInstance.attr('data-map-style') !==
                            typeof undefined
                            ? mapInstance.attr('data-map-style')
                            : false,
                        ...
                        zoomLevel = typeof mapInstance.attr('data-map-zoom') !==
                            typeof undefined &&
                            mapInstance.attr('data-map-zoom') !== ''
                            ? mapInstance.attr('data-map-zoom') * 1
                            : 17,
                        latlong = typeof mapInstance.attr('data-latlong') !==
                            typeof undefined
                        ...
                        address = typeof mapInstance.attr('data-address') !==
                            typeof undefined
                            ? mapInstance.attr('data-address').split(';')
                            : [''],
                        markerImage = typeof mapInstance.attr(
                            'data-marker-image'
                        ) !== typeof undefined
                    ...
                    if (
                        typeof mapInstance.attr('data-marker-title') !==
                            typeof undefined &&
    ...
    var documentReady = function($) {
        $('.masonry').each(function() {
            ...
            var masonryContainer = masonry.find('.masonry__container'),
                ...
                filterAllText = typeof filters.attr('data-filter-all-text') !==
                    typeof undefined
            ...
            if (
                masonryContainer.find(
                    '.masonry__item[data-masonry-filter]'
                ).length
            ) {
    ...
    var windowLoad = function() {
        ...
        $('.masonry__filters li').on('click', function() {
            ...
            if (masonryFilter.attr('data-masonry-filter') !== '*') {
                filterValue = '.filter-' +
                    masonryFilter.attr('data-masonry-filter');
            }
...
mr = (function(mr, $, window, document) {
    ...
    var documentReady = function($) {
        $('.modal-container').each(function() {
            ...
            if (modalContent.attr('data-width') !== undefined) {
                var modalWidth = modalContent
                    .attr('data-width')
                    .substr(0, modalContent.attr('data-width').indexOf('%')) *
                    1;
            ...
            if (modalContent.attr('data-height') !== undefined) {
                var modalHeight = modalContent
                    .attr('data-height')
                    .substr(0, modalContent.attr('data-height').indexOf('%')) *
                    1;
        ...
        $('.modal-trigger').on('click', function() {
            ...
            if (
                typeof modalTrigger.attr('data-modal-id') !== typeof undefined
            ) {
    ...
    mr.modals.showModal = function(modal, millisecondsDelay) {
        var delay = typeof millisecondsDelay !== typeof undefined
            ? 1 * millisecondsDelay
            : 0;
...
mr = (function(mr, $, window, document) {
    ...
    var documentReady = function($) {
        ...
        $('.menu li').on('click', function(ev) {
            var navItem = $(this), e = ev || window.event;
    ...
    mr.navigation.bar.init = function() {
        ...
        mr.navigation.bar.fixedAt = typeof fixedAt !== typeof undefined
    ...
    mr.navigation.bar.update = function() {
        ...
        if (
            mr.scroll.y > mr.navigation.bar.fixedAt &&
        ...
        if (
            mr.scroll.y < mr.navigation.bar.fixedAt && mr.navigation.bar.isFixed
        ) {
            mr.navigation.bar.isFixed = false;
    ...
    var documentReady = function($) {
        ...
        $('form[action*="createsend.com"]').each(function() {
            ...
            form.find('input[type="checkbox"]').each(function() {
                ...
                $('.input-checkbox[data-id="' + id + '"]').prepend(
                    '<div class="inner"></div>'
                );
            });
        ...
        $('form[action*="list-manage.com"]').each(function() {
            ...
            form.find('input[type="checkbox"]').each(function() {
                ...
                checkbox.before(
                    '<div class="input-checkbox"><div class="inner"></div></div>'
                );
            ...
            form.find('input[type="radio"]').each(function() {
                ...
                label = parent.find('label');
                radio.before(
                    '<div class="input-radio"><div class="inner"></div></div>'
                );
...
mr = (function(mr, $, window, document) {
    ...
    var documentReady = function($) {
        ...
        $('.notification[data-autoshow]').each(function() {
            ...
            if (typeof notification.attr('data-cookie') !== typeof undefined) {
                if (!mr.cookies.hasItem(notification.attr('data-cookie'))) {
                    mr.notifications.showNotification(
                        notification,
                        millisecondsDelay
                    );
                }
        ...
        $(
            '[data-notification-link]:not(.notification)'
        ).on('click', function() {
...
mr = (function(mr, $, window, document) {
    ...
    var documentReady = function($) {
        $('.piechart').each(function() {
            var chart = $(this), value = chart.attr('data-value') * 1;
            chart.easyPieChart({
                animate: 2000,
                barColor: '#425cbb'
            });
...
mr = (function(mr, $, window, document) {
    ...
    var documentReady = function($) {
        $(
            'a:not([href^="#"]):not([href^="tel"]):not([href^="mailto"]):not([data-lightbox]):not([href=""]):not([target="_blank"]):not(.modal-trigger):not([class*="lb-"])'
        ).on('click', function() {
    ...
    var documentReady = function($) {
        $('.tweets-feed')
            ...
            .each(function(index) {
                ...
                if (
                    typeof element.attr('data-widget-id') !== typeof undefined
                ) {
                    ...
                    TweetConfig.profile = {
                        screenName: element.attr('data-feed-name')
                    };
                } else {
